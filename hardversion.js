...
function pick() {
    ...
    for (let i = 0; i < box.length; i++) {
        ...
        calculate(box[i][0], box[i][1]);
        subsum -= guessBlack();
        console.log('黑棋下後的subsum: '+subsum);
        if(Max < subsum){
            Max = subsum;
            pickindex = i;
        }
