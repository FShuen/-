...
//電腦戰績(localstorage)
var wins = JSON.parse(localStorage.getItem('hardwin'));
var loses = JSON.parse(localStorage.getItem('hardlose'));
var ties = JSON.parse(localStorage.getItem('hardtie'));
if(wins == null){
    wins = 0;
    localStorage.setItem('hardwin', JSON.stringify(wins));
}
if(loses == null){
    loses = 0;
    localStorage.setItem('hardlose', JSON.stringify(loses));   
}
if(ties == null){
    ties = 0;
